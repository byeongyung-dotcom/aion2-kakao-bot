...
app = FastAPI(title="AION2 Server v53 StableCompareUI")
...
.search-pair{display:grid;grid-template-columns:minmax(0,1.45fr) minmax(110px,.75fr);gap:8px;padding:8px;border:1px solid var(--line);border-radius:12px;background:#0b1524}
.search-pair.a{border-color:#365f97}
.search-pair.b{border-color:#674886}
.search-pair input{width:100%;min-width:0}
@media(max-width:900px){
  .compare-search{grid-template-columns:1fr}
  .search-pair{grid-template-columns:1fr 120px}
}
...
<div class="wrap">
  ...
  <div class="panel section">
    ...
    <table>
      <thead><tr><th>항목</th><th>윤이</th><th>쵸비</th><th>차이</th></tr></thead>
      
      <tbody id="attackStats">
        <tr class="group"><td colspan="4">공격 기반</td></tr>
        <tr><td>공격력</td><td>18,420</td><td>19,180</td><td class="bad">-760</td></tr>
        <tr><td>추가 공격력</td><td>1,240</td><td>1,380</td><td class="bad">-140</td></tr>
        <tr><td>PVE 공격력</td><td>2,040</td><td>2,260</td><td class="bad">-220</td></tr>
        <tr><td>보스 공격력</td><td>860</td><td>940</td><td class="bad">-80</td></tr>

        <tr class="group"><td colspan="4">피해 증폭</td></tr>
        <tr><td>일반 피해증폭</td><td>13.2%</td><td>14.8%</td><td class="bad">-1.6%p</td></tr>
        <tr><td>무기 피해증폭(무피)</td><td>11.4%</td><td>14.1%</td><td class="bad">-2.7%p</td></tr>
        <tr><td>PVE 피해증폭</td><td>9.8%</td><td>10.9%</td><td class="bad">-1.1%p</td></tr>
        <tr><td>보스 피해증폭</td><td>4.2%</td><td>5.0%</td><td class="bad">-0.8%p</td></tr>
        <tr><td>전방 피해증폭(전피)</td><td>0%</td><td>0%</td><td>0</td></tr>
        <tr><td>후방 피해증폭(후피)</td><td>17.2%</td><td>18.8%</td><td class="bad">-1.6%p</td></tr>
        <tr><td>치명타 피해증폭</td><td>18.8%</td><td>20.1%</td><td class="bad">-1.3%p</td></tr>

        <tr class="group"><td colspan="4">조건·확률</td></tr>
        <tr><td>치명타</td><td>4,120</td><td>4,240</td><td class="bad">-120</td></tr>
        <tr><td>강타</td><td>21.5</td><td>22.8</td><td class="bad">-1.3</td></tr>
        <tr><td>명중</td><td>5,180</td><td>5,310</td><td class="bad">-130</td></tr>
        <tr><td>관통</td><td>720</td><td>760</td><td class="bad">-40</td></tr>
        <tr><td>공격 속도</td><td>18.0%</td><td>18.0%</td><td>0</td></tr>
        <tr><td>시전 속도</td><td>22.0%</td><td>24.0%</td><td class="bad">-2.0%p</td></tr>
      </tbody>
  ...
  <div class="panel section">
    ...
    <div class="split">
      <div class="owner a">
        <div class="ownerhead" id="eqHeadA">A · 윤이 · 마도성</div>
        <div class="cards" id="equipA">
          <div class="card" onclick="show('윤이 무기','+15 전설','공격력 2,480 · 무피 2.4% · 후피 마석 2개')"><div class="rowcard"><div class="icon">⚔️</div><div><div class="ctitle">+15 전설 무기</div><div class="tiny">공 2,480 · 무피 2.4%</div></div></div></div>
          <div class="card" onclick="show('윤이 상의','+13 전설','공격력 520 · 치피 0.9%')"><div class="rowcard"><div class="icon">🥋</div><div><div class="ctitle">+13 전설 상의</div><div class="tiny">공 520 · 치피 0.9%</div></div></div></div>
          <div class="card" onclick="show('윤이 장갑','+12 전설','시전속도 2.0% · 명중 120')"><div class="rowcard"><div class="icon">🧤</div><div><div class="ctitle">+12 전설 장갑</div><div class="tiny">시속 2.0% · 명중 120</div></div></div></div>
          <div class="card" onclick="show('윤이 하의','+12 전설','PVE 피해증폭 0.8%')"><div class="rowcard"><div class="icon">👖</div><div><div class="ctitle">+12 전설 하의</div><div class="tiny">PVE피증 0.8%</div></div></div></div>
          <div class="card" onclick="show('윤이 신발','+11 전설','명중 95 · 공격력 210')"><div class="rowcard"><div class="icon">🥾</div><div><div class="ctitle">+11 전설 신발</div><div class="tiny">명중 95 · 공 210</div></div></div></div>
          <div class="card" onclick="show('윤이 반지','전설','후피 1.8% · 치피 0.9%')"><div class="rowcard"><div class="icon">💍</div><div><div class="ctitle">전설 반지</div><div class="tiny">후피 1.8%</div></div></div></div>
          <div class="card" onclick="show('윤이 귀걸이','전설','무피 1.2% · 강타 0.7')"><div class="rowcard"><div class="icon">💎</div><div><div class="ctitle">전설 귀걸이</div><div class="tiny">무피 1.2%</div></div></div></div>
          <div class="card" onclick="show('윤이 목걸이','전설','일반피증 1.0% · 명중 80')"><div class="rowcard"><div class="icon">📿</div><div><div class="ctitle">전설 목걸이</div><div class="tiny">피증 1.0%</div></div></div></div>
        </div>
      </div>

      <div class="owner b">
        <div class="ownerhead" id="eqHeadB">B · 쵸비 · 마도성</div>
        <div class="cards" id="equipB">
          <div class="card" onclick="show('쵸비 무기','+17 전설','공격력 2,660 · 무피 3.1% · 후피 마석 2개')"><div class="rowcard"><div class="icon">⚔️</div><div><div class="ctitle">+17 전설 무기</div><div class="tiny">공 2,660 · 무피 3.1%</div></div></div></div>
          <div class="card" onclick="show('쵸비 상의','+15 전설','공격력 590 · 치피 1.2%')"><div class="rowcard"><div class="icon">🥋</div><div><div class="ctitle">+15 전설 상의</div><div class="tiny">공 590 · 치피 1.2%</div></div></div></div>
          <div class="card" onclick="show('쵸비 장갑','+14 전설','시전속도 3.0% · 명중 150')"><div class="rowcard"><div class="icon">🧤</div><div><div class="ctitle">+14 전설 장갑</div><div class="tiny">시속 3.0% · 명중 150</div></div></div></div>
          <div class="card" onclick="show('쵸비 하의','+14 전설','PVE 피해증폭 1.2%')"><div class="rowcard"><div class="icon">👖</div><div><div class="ctitle">+14 전설 하의</div><div class="tiny">PVE피증 1.2%</div></div></div></div>
          <div class="card" onclick="show('쵸비 신발','+13 전설','명중 120 · 공격력 240')"><div class="rowcard"><div class="icon">🥾</div><div><div class="ctitle">+13 전설 신발</div><div class="tiny">명중 120 · 공 240</div></div></div></div>
          <div class="card" onclick="show('쵸비 반지','전설','후피 2.1% · 치피 1.2%')"><div class="rowcard"><div class="icon">💍</div><div><div class="ctitle">전설 반지</div><div class="tiny">후피 2.1%</div></div></div></div>
          <div class="card" onclick="show('쵸비 귀걸이','전설','무피 1.5% · 강타 0.7')"><div class="rowcard"><div class="icon">💎</div><div><div class="ctitle">전설 귀걸이</div><div class="tiny">무피 1.5%</div></div></div></div>
          <div class="card" onclick="show('쵸비 목걸이','전설','일반피증 1.3% · 명중 100')"><div class="rowcard"><div class="icon">📿</div><div><div class="ctitle">전설 목걸이</div><div class="tiny">피증 1.3%</div></div></div></div>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="panel section">
    ...
    <div class="split">
      <div class="owner a"><div class="ownerhead" id="arcHeadA">A · 윤이</div><div class="cards" id="arcA">
        <div class="card" onclick="show('아르카나 A','Lv.18','공격력 +185 · PVE피증 +0.6%')"><div class="rowcard"><div class="icon">✦</div><div><div class="ctitle">아르카나 A</div><div class="tiny">Lv.18 · 공 +185</div></div></div></div>
        <div class="card" onclick="show('아르카나 B','Lv.16','무피 +0.7% · 명중 +45')"><div class="rowcard"><div class="icon">✧</div><div><div class="ctitle">아르카나 B</div><div class="tiny">Lv.16 · 무피 +0.7%</div></div></div></div>
        <div class="card" onclick="show('아르카나 C','Lv.20','치피 +0.8% · 후피 +0.5%')"><div class="rowcard"><div class="icon">✦</div><div><div class="ctitle">아르카나 C</div><div class="tiny">Lv.20 · 치피 +0.8%</div></div></div></div>
      </div></div>
      <div class="owner b"><div class="ownerhead" id="arcHeadB">B · 쵸비</div><div class="cards" id="arcB">
        <div class="card" onclick="show('아르카나 A','Lv.20','공격력 +220 · PVE피증 +0.8%')"><div class="rowcard"><div class="icon">✦</div><div><div class="ctitle">아르카나 A</div><div class="tiny">Lv.20 · 공 +220</div></div></div></div>
        <div class="card" onclick="show('아르카나 B','Lv.18','무피 +0.9% · 명중 +60')"><div class="rowcard"><div class="icon">✧</div><div><div class="ctitle">아르카나 B</div><div class="tiny">Lv.18 · 무피 +0.9%</div></div></div></div>
        <div class="card" onclick="show('아르카나 C','Lv.20','치피 +1.0% · 후피 +0.7%')"><div class="rowcard"><div class="icon">✦</div><div><div class="ctitle">아르카나 C</div><div class="tiny">Lv.20 · 치피 +1.0%</div></div></div></div>
      </div></div>
    </div>
  </div>
  ...
  <div class="panel section">
    ...
    <div class="note">같은 마도성끼리 비교하므로 실제 패시브 이름을 그대로 맞춰서 <b>윤이 / 쵸비 / 레벨 차이</b>로 표시. 아래 레벨은 UI 미리보기용 예시값이며, 최종본에서는 캐릭터 데이터로 자동 채움.</div>
  ...
  <div class="panel section">
    ...
    <table style="margin-top:10px">
      <thead>
        <tr><th>마도성 핵심 액티브</th><th>윤이</th><th>쵸비</th><th>차이</th></tr>
      </thead>
  ...
  <div class="panel section">
    ...
    <div class="split">
      <div class="owner a">
        <div class="ownerhead" id="skillHeadA">A · 윤이 · 마도성</div>
        <div class="cards" id="skillsA">
          <div class="card" onclick="show('화염 스킬','Lv.18','쿨 8초 · 예상 사이클 기여도 14.2%')"><div class="rowcard"><div class="icon">🔥</div><div><div class="ctitle">화염 스킬</div><div class="tiny">Lv.18</div></div></div></div>
          <div class="card" onclick="show('핵심 패시브','Lv.16','공격 계열 보정')"><div class="rowcard"><div class="icon">◆</div><div><div class="ctitle">핵심 패시브</div><div class="tiny">Lv.16</div></div></div></div>
        </div>
      </div>
      <div class="owner b">
        <div class="ownerhead" id="skillHeadB">B · 쵸비 · 마도성</div>
        <div class="cards" id="skillsB">
          <div class="card" onclick="show('불꽃 작살','Lv.20','주력 딜 스킬 · Lv.20')"><div class="rowcard"><div class="icon">🛡️</div><div><div class="ctitle">불꽃 작살</div><div class="tiny">Lv.20</div></div></div></div>
          <div class="card" onclick="show('강화의 은혜','Lv.18','피해 증폭 조건부 보정')"><div class="rowcard"><div class="icon">◆</div><div><div class="ctitle">강화의 은혜</div><div class="tiny">Lv.18</div></div></div></div>
        </div>
      </div>
    </div>
  </div>
...
const nameA=$("nameA"),serverA=$("serverA"),nameB=$("nameB"),serverB=$("serverB"),compareBtn=$("compareBtn"),loadStatus=$("loadStatus");
const charA=$("charA"),charB=$("charB"),gapKpis=$("gapKpis"),attackStats=$("attackStats");
const priorityCards=$("priorityCards"),priorityNote=$("priorityNote");
const eqHeadA=$("eqHeadA"),eqHeadB=$("eqHeadB"),equipA=$("equipA"),equipB=$("equipB");
const arcHeadA=$("arcHeadA"),arcHeadB=$("arcHeadB"),arcA=$("arcA"),arcB=$("arcB");
const passiveTitle=$("passiveTitle"),passiveAName=$("passiveAName"),passiveBName=$("passiveBName"),passiveTable=$("passiveTable"),passiveKpis=$("passiveKpis");
const activeTitle=$("activeTitle"),activeAName=$("activeAName"),activeBName=$("activeBName"),activeTable=$("activeTable"),activeKpis=$("activeKpis");
const skillHeadA=$("skillHeadA"),skillHeadB=$("skillHeadB"),skillsA=$("skillsA"),skillsB=$("skillsB");
const modal=$("modal"),m1=$("m1"),m2=$("m2"),m3=$("m3");
const E=s=>String(s??"").replace(/[&<>"']/g,m=>({"&":"&amp;","<":"&lt;",">":"&gt;","\"":"&quot;","'":"&#39;"}[m]));
const F=n=>Number(n||0).toLocaleString("ko-KR",{maximumFractionDigits:2});
const DD=(a,b,s="")=>{const d=Number(a||0)-Number(b||0);return `<span class="${d>0?'good':d<0?'bad':''}">${d>0?'+':''}${F(d)}${s}</span>`};

function profileHTML(x,side){
  const i=x.info||{},p=(DATA?.proAnalysis||{})[side==="a"?"jobProfileA":"jobProfileB"]||{};
  return `<div class="char">
    ${i.profileImage?`<img class="avatar" src="${E(i.profileImage)}" style="object-fit:cover">`:`<div class="avatar">${E((i.name||"?").slice(0,1))}</div>`}
    <div><div class="name">${E(i.name||"-")}</div><div class="meta">${E(i.server||"-")} · ${E(i.job||"-")} · Lv.${F(i.level)}</div>
    ...
    ${Number(p.backRatio)>0?`<span class="badge">후방 ${F(p.backRatio)}%</span>`:""}</div></div></div>`;
}
...
function renderAttack(a,b){
  ...
  for(const [g,names] of groups){
    const rows=names.filter(n=>A[n]||B[n]); if(!rows.length)continue;
    h+=`<tr class="group"><td colspan="4">${E(g)}</td></tr>`;
    for(const n of rows){
      const x=A[n]||{baseValue:0,combinedValue:0,unit:"number"},y=B[n]||{baseValue:0,combinedValue:0,unit:"number"};
      const xv=x.combinedValue??x.baseValue??0,yv=y.combinedValue??y.baseValue??0,s=(x.unit==="percent"||y.unit==="percent")?"%":"";
      h+=`<tr><td>${E(n)}</td><td>${F(xv)}${s}</td><td>${F(yv)}${s}</td><td>${DD(xv,yv,s)}</td></tr>`;
    }
  }
  attackStats.innerHTML=h||`<tr><td colspan="4">공격 스탯 데이터 없음</td></tr>`;
}
function renderGap(d){
  const p=d.proAnalysis||{},a=Number(d.a?.info?.combatPower||0),b=Number(d.b?.info?.combatPower||0),f=(p.priorities||[])[0];
  gapKpis.innerHTML=`
    <div class="kpi"><div class="label">전투력 차이</div><div class="value ${a>=b?'good':'bad'}">${a>=b?'+':''}${Math.round((a-b)/1000)}K</div></div>
    <div class="kpi"><div class="label">가장 큰 부족</div><div class="value">${E(f?.name||"-")}</div></div>
    <div class="kpi"><div class="label">예상 딜 회복</div><div class="value">${f?`+${Number(f.expectedRecoveryPct||0).toFixed(2)}%`:"-"}</div></div>
    <div class="kpi"><div class="label">가장 빠른 개선</div><div class="value">${E((p.priorities||[])[1]?.name||"-")}</div></div>`;
}
function renderPriority(p){
  priorityCards.innerHTML=(p.priorities||[]).slice(0,3).map(r=>`
    <div class="pcard"><div class="rank">#${E(r.rank)} ${E(r.name)}</div>
    <div class="pct">+${Number(r.expectedRecoveryPct||0).toFixed(2)}%</div>
    <div class="tiny">${E(r.action||"")}</div></div>`).join("")||`<div class="note">검증 가능한 공격 격차가 크지 않음</div>`;
  const c=p.conditionalChecks||[];
  priorityNote.textContent=c.length?`조건부 확인: ${c.slice(0,4).map(x=>x.name).join(" · ")} — 단순 수치차만으로 우선순위를 정하지 않음.`:"현재 검증 가능한 딜 회복량 기준.";
}
function detail(x){
  if(!modal) return;
  m1.textContent=x?.name||"-";
  m2.textContent=[x?.slot,x?.grade,x?.level!=null?`Lv.${x.level}`:"",x?.enhance!=null?`+${x.enhance}`:""].filter(Boolean).join(" · ");
  let a=[];
  if(x?.description)a.push(x.description);
  (x?.magicStones||[]).forEach(s=>a.push(`💎 ${s.name} ${s.value??""}`));
  (x?.options||[]).forEach(o=>a.push(`${o.name} ${o.value??""}`));
  m3.textContent=a.join("\n")||"추가 상세정보 없음";
  modal.classList.add("show");
}
function show(name,meta,desc){
  detail({name:name||"-",description:desc||"",grade:meta||""});
}
function hide(){if(modal)modal.classList.remove("show")}
function card(x,type){
  const j=encodeURIComponent(JSON.stringify(x));
  return `<div class="card" data-x="${j}"><div class="rowcard">${x.icon?`<img class="icon" src="${E(x.icon)}" style="object-fit:cover">`:`<div class="icon">${type==="장비"?"⚔️":type==="아르카나"?"✦":"◆"}</div>`}<div><div class="ctitle">${E(x.name||"-")}</div><div class="tiny">${E(type)} ${x.level!=null?`· Lv.${E(x.level)}`:""} ${x.enhance!=null?`· +${E(x.enhance)}`:""}</div></div></div></div>`;
}
function wire(){
  document.querySelectorAll("[data-x]").forEach(el=>{
    el.onclick=()=>{
      try{ detail(JSON.parse(decodeURIComponent(el.dataset.x))); }
      catch(e){ console.error("detail open failed",e); }
    };
  });
}
function lmap(rows){const m={};(rows||[]).forEach(x=>{if(x?.name)m[x.name]=x});return m}
function avg(rows){const v=(rows||[]).map(x=>Number(x.level)).filter(Number.isFinite);return v.length?v.reduce((a,b)=>a+b,0)/v.length:0}
function renderLevels(a,b,type){
  const same=(a.info?.job||"")===(b.info?.job||""),ra=type==="p"?(a.passives||[]):(a.skills||[]),rb=type==="p"?(b.passives||[]):(b.skills||[]),ma=lmap(ra),mb=lmap(rb);
  const tb=type==="p"?passiveTable:activeTable,ta=type==="p"?passiveTitle:activeTitle,ha=type==="p"?passiveAName:activeAName,hb=type==="p"?passiveBName:activeBName,k=type==="p"?passiveKpis:activeKpis;
  ta.textContent=same?`${a.info?.job||""} ${type==="p"?"패시브":"핵심 액티브 스킬"} 1:1 비교`:`직업별 ${type==="p"?"패시브":"액티브"} 투자 비교`;
  ha.textContent=a.info?.name||"A";hb.textContent=b.info?.name||"B";
  if(same){
    const names=[...new Set([...Object.keys(ma),...Object.keys(mb)])].sort();
    tb.innerHTML=names.map(n=>{const av=Number(ma[n]?.level||0),bv=Number(mb[n]?.level||0);return `<tr><td>${E(n)}</td><td>${av||"-"}</td><td>${bv||"-"}</td><td>${DD(av,bv)}</td></tr>`}).join("")||`<tr><td colspan="4">데이터 없음</td></tr>`;
  }else{
    const aa=[...ra].sort((x,y)=>Number(y.level)-Number(x.level)),bb=[...rb].sort((x,y)=>Number(y.level)-Number(x.level));let h="",n=Math.max(aa.length,bb.length);
    for(let i=0;i<n;i++)h+=`<tr><td>${E(aa[i]?.name||bb[i]?.name||"-")}</td><td>${aa[i]?.level??"-"}</td><td>${bb[i]?.level??"-"}</td><td>-</td></tr>`;
    tb.innerHTML=h||`<tr><td colspan="4">데이터 없음</td></tr>`;
  }
  const a20=ra.filter(x=>Number(x.level)>=20).length,b20=rb.filter(x=>Number(x.level)>=20).length;
  k.innerHTML=`<div class="kpi"><div class="label">20레벨 이상 수</div><div class="value">${a20} / ${b20}</div></div>
  <div class="kpi"><div class="label">평균 레벨</div><div class="value">${avg(ra).toFixed(1)} / ${avg(rb).toFixed(1)}</div></div>
  <div class="kpi"><div class="label">평균 차이</div><div class="value ${(avg(ra)-avg(rb))>=0?'good':'bad'}">${(avg(ra)-avg(rb)).toFixed(1)}</div></div>
  <div class="kpi"><div class="label">비교 방식</div><div class="value" style="font-size:17px">${same?"동일명 1:1":"직업별 투자"}</div></div>`;
}
function render(d){
  DATA=d;
  document.querySelectorAll("table").forEach(tbl=>{
    ...
    if(th.length>=4){
      th[1].textContent=d.a?.info?.name||"A";
      th[2].textContent=d.b?.info?.name||"B";
    }
  });
  charA.innerHTML=profileHTML(d.a,"a");charB.innerHTML=profileHTML(d.b,"b");renderGap(d);renderAttack(d.a,d.b);renderPriority(d.proAnalysis||{});
  eqHeadA.textContent=`A · ${d.a.info?.name||"-"} · ${d.a.info?.job||"-"}`;eqHeadB.textContent=`B · ${d.b.info?.name||"-"} · ${d.b.info?.job||"-"}`;
  equipA.innerHTML=(d.a.equipment||[]).map(x=>card(x,"장비")).join("")||`<div class="note">장비 데이터 없음</div>`;equipB.innerHTML=(d.b.equipment||[]).map(x=>card(x,"장비")).join("")||`<div class="note">장비 데이터 없음</div>`;
  arcHeadA.textContent=`A · ${d.a.info?.name||"-"}`;arcHeadB.textContent=`B · ${d.b.info?.name||"-"}`;
  arcA.innerHTML=(d.a.arcana||[]).map(x=>card(x,"아르카나")).join("")||`<div class="note">아르카나 데이터 없음</div>`;arcB.innerHTML=(d.b.arcana||[]).map(x=>card(x,"아르카나")).join("")||`<div class="note">아르카나 데이터 없음</div>`;
  renderLevels(d.a,d.b,"p");renderLevels(d.a,d.b,"a");
  skillHeadA.textContent=`A · ${d.a.info?.name||"-"} · ${d.a.info?.job||"-"}`;skillHeadB.textContent=`B · ${d.b.info?.name||"-"} · ${d.b.info?.job||"-"}`;
  skillsA.innerHTML=(d.a.skills||[]).map(x=>card(x,"스킬")).join("")+(d.a.passives||[]).map(x=>card(x,"패시브")).join("");
  skillsB.innerHTML=(d.b.skills||[]).map(x=>card(x,"스킬")).join("")+(d.b.passives||[]).map(x=>card(x,"패시브")).join("");
  wire();
}
async function compare(){
  const A={name:(nameA?.value||"").trim(),server:(serverA?.value||"").trim()};
  const B={name:(nameB?.value||"").trim(),server:(serverB?.value||"").trim()};
  if(!A.name||!A.server||!B.name||!B.server){
    loadStatus.textContent="A/B 캐릭터명과 서버를 모두 입력해줘.";
    return;
  }

  loadStatus.textContent="상세 데이터 분석 중...";
  if(compareBtn){ compareBtn.disabled=true; compareBtn.textContent="분석 중..."; }

  const q=new URLSearchParams({
    name_a:A.name,server_a:A.server,
    name_b:B.name,server_b:B.server
  });
  ...
  try{
    ...
    if(!r.ok || !d.ok){
      loadStatus.textContent=d?.message||d?.error||"한쪽 캐릭터 상세 조회 실패";
      return;
    }

    // IMPORTANT: Never navigate/reload/change layout.
    // The approved page remains mounted and only its values/cards are updated.
    render(d);
    loadStatus.textContent=`${d.a?.info?.name||A.name} ↔ ${d.b?.info?.name||B.name} 비교 완료`;
  }catch(e){
    console.error(e);
    loadStatus.textContent="비교 서버 연결 오류";
  }finally{
    if(compareBtn){ compareBtn.disabled=false; compareBtn.textContent="비교 분석"; }
  }
}
if(compareBtn) compareBtn.addEventListener("click",compare);
[nameA,serverA,nameB,serverB].forEach(el=>{
  if(el) el.addEventListener("keydown",e=>{
    if(e.key==="Enter"){e.preventDefault();compare();}
  });
});
if(modal) modal.onclick=e=>{if(e.target===modal)hide()};
window.show=show;
window.hide=hide;
...
async def openchat(msg: str = ""):
    ...
    if body in ("알림켜기", "알림끄기", "알림상태", "테스트"):
        text = "✅ AION2 v53 서버 정상" if body == "테스트" else "📱 알림 설정은 휴대폰 봇에서 처리됩니다."
