...
<div class="wrap">
  ...
  <div class="panel section">
    ...
    <div class="prio" id="priorityCards">
      <div class="pcard"><div class="rank">#1 분석 대기</div><div class="pct">—</div><div class="tiny">두 캐릭터 검색 후 계산</div></div>
      <div class="pcard"><div class="rank">#2 분석 대기</div><div class="pct">—</div><div class="tiny">두 캐릭터 검색 후 계산</div></div>
      <div class="pcard"><div class="rank">#3 분석 대기</div><div class="pct">—</div><div class="tiny">두 캐릭터 검색 후 계산</div></div>
    </div>
...
function renderEquipmentOwner(character, headId, listId){
  ...
  $(listId).innerHTML=rows.map(r=>{
    ...
    const subCells=Array.from({length:8},(_,i)=>subs[i]?`<div class="equip-substat"><span>${E(subs[i]?.name||subs[i]?.id||'-')}</span><b>${E(String(subs[i]?.value??'-'))}</b></div>`:'<div class="equip-substat empty"><span>—</span><b>—</b></div>').join('');
...
function renderEquipment(a,b){renderEquipmentOwner(a,'equipHeadA','equipListA');renderEquipmentOwner(b,'equipHeadB','equipListB');}
